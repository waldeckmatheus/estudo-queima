## A14. Ciência da Composição Corporal: Perda de Gordura com Preservação de Massa Magra
...
### A14.1. Peso Corporal vs. Composição Corporal
...
#### A14.1.1. Proporção Típica de Perda
...
#### A14.1.2. Por que Preservar Massa Magra?
...
### A14.2. Adaptação Metabólica: O Corpo Contra-Ataca
...
#### A14.2.1. Componentes do TDEE Afetados
...
#### A14.2.3. Evidência Quantitativa
...
### A14.3. Settled Point vs. Set Point
...
### A14.4. Estratégias para Preservação de Massa Magra
...
#### A14.4.3. Taxa de Perda de Peso Controlada
...
### A14.5. O Papel da Composição da Dieta

#### A14.5.1. Macronutrientes Além da Proteína
...
#### A14.5.2. Estratégias de Refeeding
...
### A14.6. Mapa de Mecanismos

```mermaid
flowchart TD
    A[Déficit Calórico Sustentado] --> B[↓ Leptina]
    A --> C[↑ Grelina]
    A --> D[↓ T3]
    A --> E[↑ Cortisol]
    B --> F[↓ TDEE]
    D --> F
    C --> G[↑ Fome]
    E --> H[↑ Catabolismo Muscular]
    F --> I[Adaptação Metabólica]
    G --> J[Risco de Abandono]
    H --> K[↓ Massa Magra]

    L[Proteína Elevada ≥ 2 g/kg] --> M[↑ MPS via mTOR]
    N[Treino Resistido] --> M
    M --> O[Preservação de MLG]
    O --> P[Manutenção da RMR]

    Q[Taxa de Perda ≤ 1%/sem] --> R[Menor Adaptação Hormonal]
    R --> P
...
### A14.7. Implicações Práticas para o Protocolo
