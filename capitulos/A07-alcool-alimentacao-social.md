...
```
Etanol → (álcool desidrogenase) → Acetaldeído → (aldeído desidrogenase) → Acetato → Acetil-CoA
```

Enquanto o fígado processa etanol, **a oxidação de gorduras é suprimida quase completamente**. Baraona & Lieber (1979) documentaram que o álcool substitui ácidos graxos como combustível hepático primário, reduzindo drasticamente a beta-oxidação. [web:111]

| Macronutriente | kcal/g | Efeito térmico | kcal líquidas efetivas/g |
|---|:---:|:---:|:---:|
| Proteína | 4,0 | ~25% | ~3,0 |
| Carboidrato | 4,0 | ~8% | ~3,7 |
| Gordura | 9,0 | ~3% | ~8,7 |
| **Álcool** | **7,1** | **~20%** | **~5,7** |
...
**① Supressão da oxidação de gorduras.** Enquanto o fígado metaboliza etanol, toda gordura ingerida na mesma refeição é direcionada para armazenamento. Mesmo um déficit calórico diário pode ser parcialmente anulado se o álcool bloqueia a lipólise por 6–8 horas.

**② Redução da síntese proteica muscular (MPS).** Parr et al. (2014) conduziram o estudo definitivo: 8 homens ativos realizaram exercício concorrente (resistência + aeróbico), depois consumiram álcool (1,5 g/kg — ~12 doses) com proteína ou carboidrato. Resultados das 8h de recuperação: [web:112]

| Condição pós-exercício | MPS (FSR %·h⁻¹) | Redução vs. proteína isolada |
|---|:---:|:---:|
| Proteína isolada (25 g whey) | 0,052 | — |
| Álcool + Proteína | 0,039 | **−24%** |
| Álcool + Carboidrato | 0,032 | **−37%** |

> **Mecanismo:** O álcool atenua a fosforilação de mTOR^Ser2448^ — o regulador central da síntese proteica — mesmo quando proteína é co-ingerida. Em um protocolo de recomposição onde a preservação muscular é prioridade absoluta (Cap. 2, Cap. 5), uma redução de 24–37% na MPS é particularmente destrutiva.
...
| Padrão de consumo | Associação com peso corporal |
|---|---|
| Consumo leve-moderado (≤1 dose/dia) | Associação nula ou levemente protetora |
| Consumo pesado/binge (≥3 doses/ocasião) | **Associação positiva** com ganho de peso e obesidade |
| Cerveja e destilados | Mais associados a adiposidade abdominal |
| Vinho (moderado) | Associação inversa em alguns estudos |
...
| Número de companheiros | Aumento médio da ingestão |
|---|:---:|
| 1 pessoa | +33% |
| 2 pessoas | +47% |
| 4 pessoas | +69% |
...
- **Extensão temporal:** refeições sociais duram mais, aumentando a janela de ingestão.
- **Modelagem social:** vemos os outros comendo e ajustamos nossa ingestão para cima.
- **Distração atencional:** conversa desvia atenção dos sinais de saciedade.
- **Norma de reciprocidade:** recusar comida oferecida gera desconforto social.
...
|---|---|
| Escolha de bebida | Destilado puro (vodka, gin) + água com gás/limão: ~65 kcal/dose vs. cerveja ~150 kcal/lata vs. caipirinha ~300 kcal |
| Limite de doses | Máximo 2 doses (homens) / 1 dose (mulheres) |
| Intercalar com água | 1 copo de água entre cada dose alcoólica |
| Buffer proteico | Priorizar proteínas disponíveis (carnes magras, queijos) antes de qualquer carboidrato |
| Técnica do prato-amostra | Montar um prato pequeno com porções de degustação em vez de repetir |
| Distanciamento do buffet | Posicionar-se longe da mesa de comida (reduz ingestão por proximidade) |
...
|---|:---:|:---:|:---:|:---:|
| 1 taça de vinho (150 mL) + jantar proteico | +100 kcal | 2–3 h supressão | Mínimo | 🟢 Baixo |
| 2 cervejas + petiscos de bar | +500 kcal | 4–5 h supressão | Moderado | 🟡 Médio |
| Churrasco típico (3–4 cervejas + picanha + pão de alho) | +1.200 kcal | 6–8 h supressão | −24% se treinou | 🟠 Alto |
| Happy hour prolongado (5+ doses + fritura + pizza) | +2.000 kcal | 8–12 h supressão | −37% se treinou | 🔴 Crítico |
...
**"Se eu beber, perco o treino do dia?"**
O treino ainda gera benefício — a MPS ainda sobe 29–57% acima do repouso mesmo com álcool. O ponto é que o benefício é **subótimo**. Melhor treinar e beber pouco do que não treinar.
...
|---|---|
| Cap. 2 — Embasamento Científico | Álcool suprime a via mTOR, o principal regulador da MPS |
| Cap. 3 — Roteiro Diário | Roteiro fixo reduz decisões em eventos (automatização alimentar) |
